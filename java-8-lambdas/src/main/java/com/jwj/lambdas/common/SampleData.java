package com.jwj.lambdas.common;
...
public class SampleData {
    ...
    public static final List<Album> albumList = Arrays.asList(aLoveSupreme, sampleShortAlbum, manyTrackAlbum);

    public static final List<Artist> artistList = Arrays.asList(johnColtrane, johnLennon, paulMcCartney, georgeHarrison,ringoStarr,theBeatles);
